...
\begin{figure}[!hb]
   \centering
   \includegraphics[clip, trim=1.5cm 1cm 0cm 0.75cm, width=0.85\linewidth]{tsne_zombiejobs}
...
\begin{figure}[!hb]
   \centering
   \includegraphics[clip, trim=1.5cm 1cm 0cm 0cm, width=0.85\linewidth]{tsne_sep2021}
