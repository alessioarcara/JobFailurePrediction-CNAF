...
%i pilot mandano in esecuzione i payload secondo un modello di "late binding":
%il payload e' individuato DOPO che il pilot e' entrato in esecuzione (anche
%per questo l'analisi semantica di prima non porta lontano).
...
\begin{figure}[!hb]
   \centering
   \includegraphics[clip, trim=1.5cm 1cm 0cm 0.75cm, width=0.75\linewidth]{tsne_zombiejobs}
